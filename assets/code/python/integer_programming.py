...
def solve_integer_program(
    ...
    """Solve an integer or binary program with PuLP."""
    ...
    problem = pulp.LpProblem("integer_program", direction)
    bounds = list(bounds or [(0, 1)] * n_vars)
    categories = list(categories or ["Binary"] * n_vars)
